Hooks.once("init", () => {
  ...
  game.settings.register("godbound-pa-options", "paradoxHp", {
    ...
    hint: "Double Con value as base HP + per-level bonus. On enable: grants proportional extra current HP (preserves relative health). On disable: clamps excess. DO NOT ACTIVATE, DEPRECATED, MIGHT BREAK SHIT",
    scope: "world",
    config: true,
    type: Boolean,
    default: false,
